...
--
-- Dumping data for table `assembledbots`
--

INSERT INTO `assembledbots` (`id`, `head`, `body`, `legs`) VALUES
(1, '1', '1', '1');
...
INSERT INTO `historydata` (`seq`, `plant`, `action`, `quantity`, `amount`, `stamp`) VALUES
